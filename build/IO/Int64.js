...
const Binary64_1 = require("./Binary64");
...
var Int64 = (function (_super) {
    ...
    Int64.prototype.parseInt64 = function (str, radix) {
        ...
        ;
        str = str.toLowerCase();
        var result = new Int64(void 0, void 0);
        while (i < str.length) {
            digit = str.charCodeAt(i);
            if ((((digit >= Binary64_1.default.CHAR_CODE_0)) && ((digit <= Binary64_1.default.CHAR_CODE_9)))) {
                digit = (digit - Binary64_1.default.CHAR_CODE_0);
            }
            else {
                if ((((digit >= Binary64_1.default.CHAR_CODE_A)) && ((digit <= Binary64_1.default.CHAR_CODE_Z)))) {
                    digit = (digit - Binary64_1.default.CHAR_CODE_A);
                    digit = (digit + 10);
                }
                else {
                    throw new Error('ArgumentError');
    ...
    Int64.prototype.toString = function (radix) {
        ...
        do {
            ...
            if (_local_4 < 10) {
                digitChars.push((_local_4 + Binary64_1.default.CHAR_CODE_0));
            }
            else {
                digitChars.push(((_local_4 - 10) + Binary64_1.default.CHAR_CODE_A));
            }
