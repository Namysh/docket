...
class IdentificationMessage extends ProtocolMessage {
    ...
    constructor(version, lang, credentials, serverId, autoconnect, userCertificate, useLoginToken, sessionOptionalSalt, failedAttempts) {
        super(4);
        ...
        this.useCertificate = userCertificate;
